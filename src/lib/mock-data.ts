...
export const MOCK_BLOGS: MockBlogPost[] = [
  ...
  },
  {
    ...
    readingMinutes: 6,
    cover:
      "https://images.unsplash.com/photo-1564415315949-7a0c4c73aab4?auto=format&fit=crop&w=1400&q=80",
  },
  {
    id: "b3",
  ...
  },
  {
    ...
    readingMinutes: 6,
    cover:
      "https://images.unsplash.com/photo-1495555961986-6d4c1ecb7be3?auto=format&fit=crop&w=1400&q=80",
  },
  {
    id: "b11",
...
export type MockGear = {
  ...
  disciplines?: ("Boxing" | "MMA" | "Muay Thai" | "BJJ" | "Kickboxing" | "Wrestling")[];
  skillLevel?: ("Beginner" | "Intermediate" | "Advanced")[];
  priceNum?: number; // USD midpoint — used for budget filtering
  trainingType?: ("Sparring" | "Bag work" | "Classes" | "Competition" | "Rolling")[];
  priorities?: ("Comfort" | "Durability" | "Protection" | "Budget" | "Style")[];
  upgradeTo?: string; // slug of upgrade product
  reason?: string; // default reasoning template
};
...
export const MOCK_GEAR: MockGear[] = [
  {
    ...
    trainingType: ["Sparring", "Competition"],
    priorities: ["Comfort", "Protection", "Style"],
    reason: "The gold standard of boxing gloves. Unmatched hand protection and knuckle padding — the gloves pros swear by.",
  },
  {
    id: "gr2",
    ...
    affiliateLink: "#",
    disciplines: ["Muay Thai", "Kickboxing", "MMA"],
    skillLevel: ["Beginner", "Intermediate"],
    trainingType: ["Sparring", "Classes"],
    priorities: ["Protection", "Comfort"],
    upgradeTo: "fairtex-sp5-shin-guards",
    reason: "Lightweight, breathable, and protective — the most popular shin guards for new Muay Thai students.",
  },
  {
    id: "gr3",
    ...
    affiliateLink: "#",
    disciplines: ["Boxing", "MMA", "Muay Thai", "Kickboxing", "BJJ"],
    skillLevel: ["Beginner", "Intermediate", "Advanced"],
    trainingType: ["Sparring", "Classes", "Competition"],
    priorities: ["Protection", "Budget"],
    reason: "Non-negotiable protection for your teeth. Boil-and-bite fit, proven in every combat sport.",
  },
  {
    id: "gr4",
    ...
    disciplines: ["MMA"],
    skillLevel: ["Intermediate", "Advanced"],
    trainingType: ["Sparring", "Bag work", "Competition"],
    priorities: ["Durability", "Protection", "Style"],
    reason: "Legendary wrist support and dual-X closure. The go-to MMA glove for serious training.",
  },
  {
    id: "gr5",
    ...
    skillLevel: ["Beginner", "Intermediate"],
    trainingType: ["Sparring", "Bag work", "Classes"],
    priorities: ["Budget", "Comfort", "Durability"],
    upgradeTo: "winning-ms-500-boxing-gloves",
    reason: "Best value gloves on the market. IMF foam absorbs impact well, wrist support is solid — punches above its price tag.",
  },
  {
    id: "gr6",
    slug: "shoyoroll-batch-100",
    name: "Shoyoroll Batch 100 Gi",
    brand: "Shoyoroll",
    category: "BJJ Gis",
    rating: 9.4,
    ...
    disciplines: ["BJJ"],
    skillLevel: ["Intermediate", "Advanced"],
    trainingType: ["Classes", "Rolling", "Competition"],
    priorities: ["Durability", "Style", "Comfort"],
    reason: "Iconic design, pearl weave durability — a gi that lasts years and looks great while doing it.",
  },
  {
    id: "gr7",
    ...
    skillLevel: ["Beginner", "Intermediate", "Advanced"],
    trainingType: ["Bag work", "Sparring", "Classes"],
    priorities: ["Durability", "Comfort"],
    reason: "Handmade in Thailand. Rock-solid for bag work and light sparring — holds its shape for years.",
  },
  {
    id: "gr8",
    ...
    skillLevel: ["Beginner", "Intermediate", "Advanced"],
    trainingType: ["Sparring", "Bag work", "Classes", "Competition"],
    priorities: ["Protection", "Budget"],
    reason: "Your hands will thank you. 180\" gives you wrist + knuckle wrap coverage — the essential under-glove layer.",
  },
  {
    id: "gr9",
    slug: "sanabul-essential-gi",
    name: "Sanabul Essential BJJ Gi",
    brand: "Sanabul",
    category: "BJJ Gis",
    rating: 8.4,
    bestFor: "Beginner BJJ",
    price: "$",
    priceNum: 60,
    image:
    ...
    disciplines: ["BJJ"],
    skillLevel: ["Beginner"],
    trainingType: ["Classes", "Rolling"],
    priorities: ["Budget", "Comfort"],
    upgradeTo: "shoyoroll-batch-100",
    reason: "IBJJF-legal, preshrunk, and affordable — the smart starter gi that won't fall apart.",
  },
  {
    id: "gr10",
    slug: "fairtex-sp5-shin-guards",
    name: "Fairtex SP5 Shin Guards",
    brand: "Fairtex",
    category: "Shin Guards",
    rating: 9.3,
    bestFor: "Advanced Muay Thai",
    price: "$$$",
    priceNum: 150,
    image:
    ...
    skillLevel: ["Intermediate", "Advanced"],
    trainingType: ["Sparring", "Competition"],
    priorities: ["Protection", "Durability"],
    reason: "Pro-grade leather, superior protection, and slim profile — what the Bangkok fight scene actually wears.",
  },
  {
    id: "gr11",
    slug: "title-classic-headgear",
    name: "Title Classic Training Headgear",
    brand: "Title",
    category: "Headgear",
    rating: 8.7,
    bestFor: "Boxing sparring",
    price: "$$",
    priceNum: 80,
    image:
    ...
    reason: "Full cheek + chin coverage. Perfect for first sparring sessions when you're still learning to slip.",
  },
  {
    id: "gr12",
    slug: "nike-hyperko-boxing-shoes",
    name: "Nike HyperKO 2 Boxing Shoes",
    brand: "Nike",
    category: "Boxing Shoes",
    rating: 9.1,
    bestFor: "Boxing footwork",
    price: "$$$",
    priceNum: 160,
    image:
    ...
    disciplines: ["Boxing"],
    skillLevel: ["Intermediate", "Advanced"],
    trainingType: ["Sparring", "Competition", "Classes"],
    priorities: ["Comfort", "Style"],
    reason: "Lightweight, stable pivot, and great grip. Essential once you start caring about footwork.",
  },
  {
    id: "gr13",
    slug: "jaco-compression-shorts",
    name: "Jaco Resurgence MMA Shorts",
    brand: "Jaco",
    category: "MMA Shorts",
    rating: 8.9,
    bestFor: "MMA training",
    ...
    skillLevel: ["Beginner", "Intermediate", "Advanced"],
    trainingType: ["Classes", "Sparring", "Competition", "Rolling"],
    priorities: ["Durability", "Comfort"],
    reason: "Flex fabric, crotch gusset, non-restrictive — move freely in every direction without worrying about tears.",
  },
  {
    id: "gr14",
    slug: "rdx-jump-rope",
    name: "RDX Speed Jump Rope",
    brand: "RDX",
    category: "Conditioning",
    rating: 8.5,
    bestFor: "Cardio + footwork",
    price: "$",
    priceNum: 15,
    image:
    ...
    disciplines: ["Boxing", "MMA", "Muay Thai", "Kickboxing"],
    skillLevel: ["Beginner", "Intermediate", "Advanced"],
    trainingType: ["Bag work", "Classes"],
    priorities: ["Budget"],
    reason: "The cheapest upgrade to your cardio and footwork. Every fighter's warmup for a reason.",
  },
];
