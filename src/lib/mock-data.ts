...
export const MOCK_FIGHTERS: MockFighter[] = [
  ...
  },
  {
    ...
    bio: "Flashy bantamweight champion known for highlight-reel knockouts and creative striking.",
    notableWins: ["Aljamain Sterling", "Petr Yan", "Marlon Vera"],
    style: ["Creative striking", "Counter-punching", "Range management"],
  },
  {
    id: "f8",
    slug: "belal-muhammad",
    ...
    bio: "Welterweight champion who grinds out victories with relentless pace and wrestling pressure.",
    notableWins: ["Leon Edwards", "Gilbert Burns", "Sean Brady"],
    style: ["Wrestling", "Pressure", "Cardio"],
  },
  {
    id: "f9",
    ...
    image:
      "https://images.unsplash.com/photo-1517438476312-10d79c077509?auto=format&fit=crop&w=900&q=80",
    bio: "Middleweight champion from South Africa. Relentless pressure fighter with knockout power in both hands.",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1599058917212-d750089bc07e?auto=format&fit=crop&w=900&q=80",
    bio: "Heavyweight champion. Unusually fast and technical for the division with devastating first-round finishes.",
